...
public class CadastroPessoalActivity extends AppCompatActivity {
    ...
    Toolbar mToolbar;
    TextView txtFullName, txtAge, txtEmail, txtEstate, txtCity, txtAdress, txtNumber, txtName, txtPass, txtConfirmPass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtName = findViewById(R.id.cad_pessoa_edit_nomeusuario);
